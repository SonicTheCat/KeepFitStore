...
namespace KeepFitStore.Data.Migrations
{
    ...
    [Migration("20190801123924_ImageAddedForJob")]
    partial class ImageAddedForJob
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeepFitStore.Domain.JobApplicant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("ExperienceInSelling");
            ...
            modelBuilder.Entity("KeepFitStore.Domain.JobPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KeepFitStore.Domain.KeepFitUserFavoriteProducts", b =>
                {
                    b.Property<string>("KeepFitUserId");

                    b.Property<int>("ProductId");

                    b.HasKey("KeepFitUserId", "ProductId");
            ...
            modelBuilder.Entity("KeepFitStore.Domain.JobApplicant", b =>
                {
                    b.HasOne("KeepFitStore.Domain.JobPosition", "Position")
                        .WithMany("Applicants")
